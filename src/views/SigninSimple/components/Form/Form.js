...
//notice when to import with { } and when not to.
    ...
    if (formState.isValid) {
      ...
      .then( response => {
        if (response && response.data && response.data.success) {
          //store what is returned to the store for later usage.
          StorageService.add('token', response.data.data.token);
          StorageService.add('company', JSON.stringify(response.data.data.company));
          //console.log(StorageService.get('company'));
